...
namespace AnalyzeDomains.Infrastructure.Services
{
    public class SocksService : ISocksService, IDisposable
    {
        ...
        private readonly SemaphoreSlim _semaphore = new(Environment.ProcessorCount * Environment.ProcessorCount, Environment.ProcessorCount * Environment.ProcessorCount); // Ensures single HttpClient creation
