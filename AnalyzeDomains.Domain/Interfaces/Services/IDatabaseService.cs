...
{    public interface IDatabaseService
    {
        ...
        Task<List<CompletedEvent>> ReadUserInfoForEvents(CancellationToken cancellationToken);        Task SiteWasValidated(SiteInfo siteInfo, CancellationToken cancellationToken);
        
        // New insert methods for database tables
